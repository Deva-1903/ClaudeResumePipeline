...
- CS 689 generative models: RealNVP and DDPM from scratch in JAX; 8 architectures benchmarked on CIFAR-10; reverse-mode autodiff over matrix operations from scratch.
...
| CS 689 Generative Models (JAX) | Applied Scientist, ML Engineer |
...
| refusal-decay | Applied Scientist (only when bullets verified) |
