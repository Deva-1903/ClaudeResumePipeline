...
\begin{itemize}
  ...
  \item Served as primary technical POC, collaborating cross-functionally with clinical and product teams, onboarded a second developer to on-call readiness in \textbf{$\sim$6 weeks}, and piloted a COO-sponsored GitHub Copilot experiment.
\end{itemize}
...
\begin{itemize}
  ...
  \item Migrated core repositories from JavaScript to TypeScript and shipped a production LLM auto-commenting feature (\textbf{4-bit quantized Llama-7B via llama.cpp in C/C++}) with async queued generation and content-safety filtering.
\end{itemize}
...
\begin{itemize}
  \item Optimized C++ matrix multiplication from a naive baseline through cache-aware tiling, \textbf{AVX/SIMD} vectorization, register-aware micro-kernels, and \textbf{OpenMP}, profiling L1/L3/TLB misses with \textbf{perf} and inspecting generated assembly.
\end{itemize}
...
\begin{itemize}
  \item Built a well-architected multi-stage backend service (Python, FastAPI) turning open-ended queries into structured entity tables with deterministic extraction and \textbf{cell-level provenance}; hardened with \textbf{150+ tests}.
\end{itemize}
...
%----------SKILLS----------
\section{Skills}
\skillLine{Languages \& Databases}{C++, Java, Python, TypeScript, JavaScript, SQL, Bash, PostgreSQL, MongoDB, SQLite}
\skillLine{Frameworks / Tools}{Node.js, Express, FastAPI, React, Next.js, Git, GitHub Actions, REST APIs}
\skillLine{Algorithms / Systems}{data structures \& algorithms, AVX/SIMD, cache-aware design, OpenMP, Spark / PySpark, perf profiling, Linux}
